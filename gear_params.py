...
SN_CURVES = {
    "Waterloo_SMDIdbase_Iter068": {
        ...
        "fatigue_strength_at_1e6": 1356.0 * (2e6) ** (-0.055),  # ≈610.5 MPa (Basquin-consistent)
        "uts": 1355.7,              # MPa, measured UTS of the tested specimen (Waterloo Iter_068 PDF)
        "source": "Waterloo SMDIdbase, Iteration #68. Q&T AISI 4140, 300 HB. "
                  "σ′f and b from https://fde.uwaterloo.ca/Fde/Materials/SMDIdbase/Steel/FatigueReports/Iter_068.pdf; "
                  "fatigue strength at 10^6 derived from the Basquin fit (v4.1).",
    },
    "Waterloo_SMDIdbase_Iter066": {
        "sigma_f_prime": 1684.0,
        "b": -0.070,
        "fatigue_strength_at_1e6": 1684.0 * (2e6) ** (-0.070),  # ≈609.9 MPa (Basquin-consistent)
        "uts": 1537.0,              # MPa, measured UTS of the tested specimen (Waterloo Iter_066 PDF)
        "source": "Waterloo SMDIdbase, Iteration #66. Q&T AISI 4140, 300 HB. "
                  "σ′f and b from https://fde.uwaterloo.ca/Fde/Materials/SMDIdbase/Steel/FatigueReports/Iter_066.pdf; "
                  "fatigue strength at 10^6 derived from the Basquin fit (v4.1).",
    },
}
