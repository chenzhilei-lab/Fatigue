...
the stability of the variance apportionment.
...
shows that more than half of the total prediction variance---55.3\%--- % @source: size_surface_standard_var_pct
...
uncertainty in gear bending fatigue life originates from a single
decision: which size-and-surface factor formulation to use. Not material
