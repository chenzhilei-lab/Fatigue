...
In practical terms: at this load level almost every standard chain
predicts infinite life, so the dataset contains virtually no failure
information for the statistical model to split among the five
factors---the decomposition is starved of data, not broken.
