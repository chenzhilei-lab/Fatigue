...
shows that more than half of the total prediction variance---55.3\%---
originates from a single decision: which size-and-surface factor
formulation to trust. % @source: size_surface_standard_var_pct
...
of handbook. An engineer who selects FKM, Goodman, and an as-forged
roughness assumption---all defensible within published standards---will
report a predicted life as short as $1.6\times10^3$ cycles. % @source: sweep.json (FKM+Goodman+as-forged min Nf)
A colleague who
