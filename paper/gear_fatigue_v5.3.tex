...
share varying from 38.8\% to 55.3\% as the $Y_{Sa}$ baseline applied
to AGMA/FKM entries spans 1.16--2.06, with the standard remaining the
top-ranked factor throughout (a Std$=$Rz tie occurs only at the most
extreme 0.75$\times$ perturbation).
