% ================================================================
% gear_fatigue_v3.5.tex — Gear Bending Fatigue Variance Decomposition
% v3.5: Full rewrite — AFT numbers corrected to EM-estimated ground truth,
...
% All numbers from output/aft_anova.json (EM estimation, 2000 bootstrap) — v3.5
...
version), and the three dominant
  ...
  \item \textbf{Applicability bound at high censoring fractions.} The
        ...
        uniquely identified values. Their qualitative ranking
  ...
  \item \textbf{Incomplete interaction modeling.} The present analysis
        ...
        combination and is deferred to Phase~2.
