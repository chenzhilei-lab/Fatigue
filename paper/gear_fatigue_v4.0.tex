...
life prediction. A single through-hardened 42CrMo4 spur gear at
...
5\%) and 30\% censoring. The decomposition recovered the true shares
...
on full standard divergence (\S\ref{sec:stress_concentration}).}
\label{tab:anova}
\footnotesize
\begin{tabular}{lrrr}
\toprule
...
artifact of the particular 144-combination dataset.}
...
15.6~pp (2.6\% vs.\ 18.2\%)---precisely the factors whose levels most
...
\begin{enumerate}
  ...
  \item \textbf{Limitations of purely numerical UQ without physical
        ...
        S--N curves, and single torque operating point. No experimental
