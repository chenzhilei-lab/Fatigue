% ================================================================
% gear_fatigue_v2.6.tex — Gear Bending Fatigue Variance Decomposition
...
% Versions preserved: v1.0, v2.0, v2.1, v2.2, v2.3, v2.4, v2.5
% ================================================================
...
are minor. Bootstrap validation (100 draws, RNG seed~42) confirms
stable rankings. Predicted fatigue life spans from $3.3\times10^2$ to
...
We bootstrap-resample the 116 finite-life entries 100 times (RNG
...
is stable under resampling. Standard choice (mean 32.2\%, CI
[21.1, 44.9]) and mean-stress correction (mean 32.4\%, CI
[18.6, 47.6]) have overlapping CIs. Surface roughness (mean 9.5\%, CI
[0.8, 20.7]) and the interaction term (mean 5.5\%, CI [0.0, 13.2]) are
distinguishable from zero but with wider relative uncertainty. The
damage rule's CI includes zero [0.0, 5.4].
...
95\% CI (100 draws, RNG seed~42). Two factors account for 62.0\% of total
log-variance.}
\label{fig:variance}
\end{figure}
...
Three published experimental studies---including one previously
published in this journal---provide context for our numerical
results, though none constitutes a direct validation of our
specific gear-and-load combination.
...
three studies demonstrate that (a)~published experimental gear bending
