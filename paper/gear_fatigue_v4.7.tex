% ================================================================
% gear_fatigue_v4.7.tex — Method-Induced Uncertainty in Gear Bending Fatigue
...
% Prior versions preserved: v1.0–v4.6
% ================================================================
...
\caption{Y_Sa baseline sensitivity. The standard-choice variance fraction
is plotted against the Y_Sa perturbation factor applied to AGMA and FKM
entries (ISO entries retain Y_Sa = 1.55). Within the plausible range
(0.95--1.15$\times$, shaded), the deviation from baseline (55.3\%) is at
...
models (Phase~2). @source: output/two\_level\_variable\_amplitude.json}
\label{fig:two_level}
\end{figure}
...
\caption{Multi S--N curve sensitivity (supplementary result). Left:
...
@source: output/multi\_sn\_sensitivity.json}
\label{fig:multi_sn}
\end{figure}
...
@source: output/sobol\_censoring\_gradient.json}
...
\centering
\includegraphics[width=\columnwidth]{../output/fig8_multi_sn_sensitivity.png}
\caption{Multi S--N curve sensitivity analysis. Left: S--N source
variance share rises from 2.5\% (2 nearly-identical Waterloo curves)
to 34.7\% (5 curves spanning realistic 42CrMo4 heat-treatment states).
Right: fatigue strength at $10^6$~cycles for the five S--N curve levels.
This demonstrates that the baseline 2.5\% S--N share is a lower bound
reflecting limited material-factor representation, not evidence that
material variability is unimportant.}
\label{fig:multi_sn}
\end{figure}
